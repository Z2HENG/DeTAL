...
class PtTransformer(nn.Module):
    ...
    def __init__(
        ...
        # init the temporal modelling module
    ...
    def forward(self, video_list):
        ...
        # temporal modelling for CLIP frame features
        for per_video in video_list:
            # (C, T) -> (T, B, C)
            video_feats = per_video['feats'].permute(1, 0).unsqueeze(1)
            new_video_feats = self.temporalModelling(video_feats)
            per_video['feats'] = new_video_feats.squeeze(1).permute(1, 0)
